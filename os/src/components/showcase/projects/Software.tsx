    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                <h2>ismaila2512.com</h2>
                <br />
                <p>
                    ismaila2512.com is my portfolio website, and also the
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://ismaila2512.vercel.app/"
                    >
                        here
                    </a>{' '}
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://ismaila2512.com"
                        >
                            <p>
                                <b>[3D Site]</b> - ismaila2512.com
                            </p>
                        </a>
                    </li>
                    <li>
                        ...
                        >
                            <p>
                                <b>[OS Site]</b> - ismaila2512.vercel.app
                            </p>
                        </a>
                    </li>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/ismaila2512/portfolio-website"
                        >
                            <p>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/ismaila2512/portfolio-inner-site"
                        >
                            <p>
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://twitter.com/ismaila2512"
                    >
                        @ismaila2512
                    </a>
                </p>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/ismaila2512/gsts_assets"
                        >
                            <p>
                                <b>[GitHub]</b> - Guntattchment Saga The Sequel
                                Assets Repository
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/ismaila2512/skip-the-scroll"
                        >
                            <p>
