...
const CREDITS = [
    {
        ...
        rows: [['Mohammed Ismail', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Mohammed Ismail', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Mohammed Ismail', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2026 Mohammed Ismail'}
        >
            <div
