    ...
    async function submitForm() {
        ...
        try {
            ...
            const res = await fetch(
                'https://api.ismaila2512.com/api/contact',
                {
                    method: 'POST',
                    headers: {
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/ismaila2512'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/ismailvp10'}
                    />
                </div>
            </div>
            <div className="text-block">
                ...
                <p>
                    <b>Email: </b>
                    <a href="mailto:ismailqudsi2004@gmail.com">
                        ismailqudsi2004@gmail.com
                    </a>
                </p>
